...
class popper_recent_comments extends WP_Widget {
	...
	function __construct() {
        $widget_ops = array( 'classname' => 'widget_popper_recent_comments', 'description' => __('Displays recent comments with user avatar and excerpt.', 'popper') );
        parent::__construct( 'widget_popper_recent_comments', __('Enhanced Recent Comments','popper'), $widget_ops );
    }
